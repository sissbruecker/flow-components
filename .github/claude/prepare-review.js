 ...
 *
 * The upstream reference checkouts (reference/flow, reference/web-components)
 * are cloned by a separate workflow step; this script only records their
 * absolute paths in the overview.
 *
 * Usage:
